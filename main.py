...
bot = telebot.TeleBot("5424746586:AAGX-3cqvuxfO8lI_cdXe_NsWJPfswSNRxI")
...
def start(message):
	...
	if user["is_passed"]:
		bot.send_message(message.from_user.wid, "Ви вже пройшли це тестування. Вдруге пройти неможливо")
		return
